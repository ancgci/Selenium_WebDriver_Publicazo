...
// Cardastro sem sucesso # features\CT0013-CadSenhaFake.feature


Given('o usuário está na pagina de cadastro 4', { timeout: 50 * 1000 }, async () => {
...
When('o usuário preenche senha e confirmação de senha divergentes', async () => {
...
When('o usuário clica no botão cadastrar 4', async () => {
    await driver.findElement(By.name("commit")).click()

});

Then('o sistema exibe uma mensagem de erro 4', async () => {
    await driver.findElement(By.css(".toast-message")).getText() == "Password confirmation não é igual a Password"
});
